# Stage_1_1_SimpleSpringBlog

![Демо работы](./demo.gif)

## *EN*
#### Link to the following project using Spring Boot: https://github.com/AlexForGH/Stage_1_2_SimpleSpringBootBlog.git
...
## *RU*
#### Ссылка на следующий проект с использованием Spring Boot: https://github.com/AlexForGH/Stage_1_2_SimpleSpringBootBlog.git
